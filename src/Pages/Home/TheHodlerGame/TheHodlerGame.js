      ...
      <div className="lg:mt-[200px] md:mt-[150px] mt-[50px] px-4">
         <div className="max-container ">
            ...
            <div className="lg:w-[880px] mx-auto">
               <p className="text-center text-midnight text-gray md:leading-[30px] mb-4 md:text-normal  font-sfReg">
               ...
               <p className="text-center text-gray md:leading-[30px] mb-4 md:text-normal  font-sfReg">
