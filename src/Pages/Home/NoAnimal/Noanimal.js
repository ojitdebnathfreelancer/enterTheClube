         ...
         <div className="max-container ">
            <div className="grid md:grid-cols-4 gap-6 lg:w-[950px] mx-auto mt-3">
               ...
               <div className="md:col-span-3 lg:ml-28">
                  <Title
                     title={"No animal pfp bullsh*t."}
                     classes={"lg:text-start md:text-start text-center"}
                  />
                  <p className="text-gray font-sfReg md:leading-[30px] md:text-normal mb-3 lg:text-start md:text-start text-center">
                     Lorem ipsum dolor sit amet consectetur adipisicing elit.
                     Quia magnam vel eos fuga voluptate esse minus consequatur
                     sunt accusamus quae.
                  </p>
                  <p className="text-gray font-sfReg md:leading-[30px] md:text-normal lg:text-start md:text-start text-center">
                     Lorem ipsum dolor sit amet consectetur adipisicing elit.
                     Quia magnam vel eos fuga voluptate esse minus consequatur
